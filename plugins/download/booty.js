...
async function handlebooty(bot) {
  bot.onText(/^\.booty$/, async (msg) => {
    let res = await axios.get(`https://api.lolhuman.xyz/api/random/nsfw/booty?apikey=${asupan}`, { responseType: 'arraybuffer' })
  try{
