...
async function handleneko(bot) {
  bot.onText(/^\.neko$/, async (msg) => {
    let res = await axios.get(`https://api.lolhuman.xyz/api/random2/neko?apikey=${asupan}`, { responseType: 'arraybuffer' })
    try{
