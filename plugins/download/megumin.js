...
async function handlemegumin(bot) {
  bot.onText(/^\.megumin$/, async (msg) => {
    let res = await axios.get(`https://api.lolhuman.xyz/api/random/sfw/megumin?apikey=${asupan}`, { responseType: 'arraybuffer' })
    try{
