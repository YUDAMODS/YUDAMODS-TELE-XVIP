...
async function handleboot(bot) {
  bot.onText(/^\.ecchi$/, async (msg) => {
    let res = await axios.get(`https://api.lolhuman.xyz/api/random/nsfw/ecchi?apikey=${asupan}`, { responseType: 'arraybuffer' })
    try{
