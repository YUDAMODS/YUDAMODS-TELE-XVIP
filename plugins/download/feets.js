...
async function handlefeets(bot) {
  bot.onText(/^\.feets$/, async (msg) => {
    let res = await axios.get(`https://api.lolhuman.xyz/api/random/nsfw/feets?apikey=${asupan}`, { responseType: 'arraybuffer' })
    try{
