    ...
    if args.upload:
        ...
        printer('🚀 Upload: %0.2f M%s/s' %
                ((results.upload / 1000.0 / 1000.0) / args.units[1],
                 args.units[0]),
                quiet)
        printer("\n🤖 Bot specs:\n• Bot Owner: Mr.Felix Developer\n• Bot Name: KawaiRun Beta Botz\n• Bot Version: 1.0.0\n• Bot Description: Harap Tidak Membagikan Skrip Geratis.\n\n▶︎ POWERED BY @Globalelits\n▶︎ Script By @Globalelits")
    else:
